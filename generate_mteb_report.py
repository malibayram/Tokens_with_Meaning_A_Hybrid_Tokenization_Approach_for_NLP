...
def generate_charts(model_data):
    ...
    avg_chart = os.path.join("figures", "mteb_average_scores.png")
...
def main():
    ...
    lines.append("![Overall MTEB Comparison](figures/mteb_comparison.jpg)\n")

    # Fallback average chart (generated here)
    generate_charts(data)
    lines.append("![Average MTEB Scores](figures/mteb_average_scores.png)\n")
